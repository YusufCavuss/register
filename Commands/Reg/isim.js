...
let embed = new Discord.MessageEmbed()
    .setDescription(`<@!${adam.user.id}> adlı kullanıcının ismi değiştirildi!`)
    .addField(`Kullanıcı`, `<@!${adam.user.id}>`, true)
    .addField(`Yeni Ismi`, `° ${isim.charAt(0).toUpperCase() + isim.slice(1).toLowerCase()}・${yas}`, true)
...
let newStaffData = new Register({
    ...
    userId: message.author.id, totalRegister: 0,
    womanRegister: 0, manRegister: 0, userNames: []
    }).save()} else {
